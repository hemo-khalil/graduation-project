...
content = Image.open("C:/Users/10711/OneDrive/سطح المكتب/Neural-Style-Transfer-master/outputs/dark-knight/img.jpg").convert("RGB")
content = transform(content).to(device)
print("COntent shape => ", content.shape)
style = Image.open("C:/Users/10711/OneDrive/سطح المكتب/Neural-Style-Transfer-master/outputs/dark-knight/style.jpg").convert("RGB")
...
ax1.imshow(imcnvt(content),label = "img")
...
print_after = 500
epochs = 1000
optimizer = torch.optim.Adam([target],lr=0.009)
